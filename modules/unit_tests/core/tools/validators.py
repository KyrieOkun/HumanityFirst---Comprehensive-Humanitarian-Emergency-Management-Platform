...
class ISLatTest(unittest.TestCase):
    """
        ...
        We can convert D/M/S or DбуM'S" format into decimal degrees:

          Zero padded, separated by spaces or : or (d, m, s) or (бу, ', ") or run
    ...
    def testValid(self):
        ...
        value, error = validator(u"81бу16'42.348\"N")
        assertEqual(error, None)
    ...
    def testInvalid(self):
        ...
        value, error = validator(u"91бу16'42.348\"N")
        assertNotEqual(error, None)
...
class ISLonTest(unittest.TestCase):
    ...
    def testValid(self):
        ...
        value, error = validator(u"121бу16'42.348\"E")
        assertEqual(error, None)
    ...
    def testInvalid(self):
        ...
        value, error = validator(u"181бу16'42.348\"E")
        assertNotEqual(error, None)
