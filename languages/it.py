...
'This is the way to transfer data between machines as it maintains referential integrity...duplicate data should be removed manually 1st!': 'Questo è il modo per trasferire i dati fra macchine, come sostiene integrità referenziale. ... dati duplicati 1�?deve essere rimosso manualmente.',
