...
'Term for the third-level within-country administrative division (e.g. City or Town).': 'Prazo para o 3ᵉ�?nível de divisão administrativa dentro do país (por exemplo, Cidade ou Municipio).',
...
'This is the way to transfer data between machines as it maintains referential integrity...duplicate data should be removed manually 1st!': 'Este é o caminho para a transferência de dados entre máquinas que mantém a integridade referencial...duplicado dados devem ser removidos manualmente 1ᵉ�?',
