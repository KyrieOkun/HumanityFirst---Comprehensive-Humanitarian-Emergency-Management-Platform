...
start:f.s,end:m,extendedProps:{popupTitle:k,description:l}};f.pe||(l.editable=!1);f.pd||(l.extendedProps.deletable=!1);e&&f.c&&(f=e[f.c],f!==r&&(l.color=f));g.push(l)});return g},_updateItem:function(a){let b=a.event;a=a.revert;let c=this.resources[b.source.id],g={id:b.id};if(c.useTime)g.s=b.start.toISOString();else{var d=b.start.getTimezoneOffset();g.s=moment(b.start).subtract(d,"minutes").toISOString().slice(0,10)}if(c.end)if(c.useTime)g.e=moment(b.end).subtract(1,"seconds").toISOString();else{d=
b.start.getTimezoneOffset();let f=moment(b.end).subtract(1,"days").endOf("day");g.e=f.subtract(d,"minutes").toISOString().slice(0,10)}let e=this;this._sendItems(c,{u:[g]},function(){c.reloadOnUpdate?e.reload():c._cache.updateItem(b.id,{start:b.start,end:b.end})},a)},_deleteItem:function(a,b){let c=a.event,g=this.resources[c.source.id];this._sendItems(g,{d:[{id:c.id}]},function(){c.remove();g._cache.deleteItem(c.id);"function"===typeof b&&b()})},_sendItems:function(a,b,c,g){let d=h('input[name="_formkey"]',
this.element).val();b=JSON.stringify(h.extend({k:d},b));let e=this;this._showThrobber();h.ajaxS3({type:"POST",url:a.ajaxURL,data:b,dataType:"json",retryLimit:0,contentType:"application/json; charset=utf-8",success:function(){"function"===typeof c&&c();e._hideThrobber()},error:function(){"function"===typeof g&&g();e._hideThrobber()}})},reload:function(){this.resources.forEach(function(a){a._cache.clear()});this.calendar.refetchEvents()},_showThrobber:function(){this.throbber.css({visibility:"visible"});
this.reloadButton.prop("disabled",!0)},_hideThrobber:function(){this.throbber.css({visibility:"hidden"});this.reloadButton.prop("disabled",!1)},_bindEvents:function(){return!0},_unbindEvents:function(){return!0}})})(jQuery);
