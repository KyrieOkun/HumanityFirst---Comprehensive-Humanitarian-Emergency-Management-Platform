/*
 ...
 2015-2021 (c) White Nash
 @license MIT

 requires jQuery 1.9.1+
 requires jQuery UI 1.10 widget factory
 requires jQuery jstree 3.0.3
 2013-2021 (c) White Nash
 @license MIT
...
p[0].nodeType;return{element:p,isWindow:r,isDocument:w,offset:r||w?{left:0,top:0}:a(m).offset(),scrollLeft:p.scrollLeft(),scrollTop:p.scrollTop(),width:p.outerWidth(),height:p.outerHeight()}}};a.fn.position=function(m){if(!m||!m.of)return n.apply(this,arguments);m=a.extend({},m);var p="string"===typeof m.of?a(document).find(m.of):a(m.of),r=a.position.getWithinInfo(m.within),w=a.position.getScrollInfo(r),x=(m.collision||"flip").split(" "),B={};var t=d(p);p[0].preventDefault&&(m.at="left top");var u=
t.width;var y=t.height;var v=t.offset;var C=a.extend({},v);a.each(["my","at"],function(){var z=(m[this]||"").split(" ");1===z.length&&(z=h.test(z[0])?z.concat(["center"]):f.test(z[0])?["center"].concat(z):["center","center"]);z[0]=h.test(z[0])?z[0]:"center";z[1]=f.test(z[1])?z[1]:"center";var D=k.exec(z[0]);var F=k.exec(z[1]);B[this]=[D?D[0]:0,F?F[0]:0];m[this]=[q.exec(z[0])[0],q.exec(z[1])[0]]});1===x.length&&(x[1]=x[0]);"right"===m.at[0]?C.left+=u:"center"===m.at[0]&&(C.left+=u/2);"bottom"===m.at[1]?
C.top+=y:"center"===m.at[1]&&(C.top+=y/2);var A=b(B.at,u,y);C.left+=A[0];C.top+=A[1];return this.each(function(){var z,D=a(this),F=D.outerWidth(),E=D.outerHeight(),G=parseInt(a.css(this,"marginLeft"),10)||0,I=parseInt(a.css(this,"marginTop"),10)||0,H=F+G+(parseInt(a.css(this,"marginRight"),10)||0)+w.width,J=E+I+(parseInt(a.css(this,"marginBottom"),10)||0)+w.height,M=a.extend({},C),R=b(B.my,D.outerWidth(),D.outerHeight());"right"===m.my[0]?M.left-=F:"center"===m.my[0]&&(M.left-=F/2);"bottom"===m.my[1]?
M.top-=E:"center"===m.my[1]&&(M.top-=E/2);M.left+=R[0];M.top+=R[1];var S={marginLeft:G,marginTop:I};a.each(["left","top"],function(L,O){if(a.ui.position[x[L]])a.ui.position[x[L]][O](M,{targetWidth:u,targetHeight:y,elemWidth:F,elemHeight:E,collisionPosition:S,collisionWidth:H,collisionHeight:J,offset:[A[0]+R[0],A[1]+R[1]],my:m.my,at:m.at,within:r,elem:D})});m.using&&(z=function(L){var O=v.left-M.left,P=O+u-F,Q=v.top-M.top,U=Q+y-E,N={target:{element:p,left:v.left,top:v.top,width:u,height:y},element:{element:D,
left:M.left,top:M.top,width:F,height:E},horizontal:0>P?"left":0<O?"right":"center",vertical:0>U?"top":0<Q?"bottom":"middle"};u<F&&e(O+P)<u&&(N.horizontal="center");y<E&&e(Q+U)<y&&(N.vertical="middle");c(e(O),e(P))>c(e(Q),e(U))?N.important="horizontal":N.important="vertical";m.using.call(this,L,N)});D.offset(a.extend(M,{using:z}))})};a.ui.position={fit:{left:function(m,p){var r=p.within,w=r.isWindow?r.scrollLeft:r.offset.left,x=r.width,B=m.left-p.collisionPosition.marginLeft;r=w-B;var t=B+p.collisionWidth-
x-w;p.collisionWidth>x?0<r&&0>=t?(p=m.left+r+p.collisionWidth-x-w,m.left+=r-p):m.left=0<t&&0>=r?w:r>t?w+x-p.collisionWidth:w:m.left=0<r?m.left+r:0<t?m.left-t:c(m.left-B,m.left)},top:function(m,p){var r=p.within,w=r.isWindow?r.scrollTop:r.offset.top,x=p.within.height,B=m.top-p.collisionPosition.marginTop;r=w-B;var t=B+p.collisionHeight-x-w;p.collisionHeight>x?0<r&&0>=t?(p=m.top+r+p.collisionHeight-x-w,m.top+=r-p):m.top=0<t&&0>=r?w:r>t?w+x-p.collisionHeight:w:m.top=0<r?m.top+r:0<t?m.top-t:c(m.top-B,
m.top)}},flip:{left:function(m,p){var r=p.within,w=r.offset.left+r.scrollLeft,x=r.width,B=r.isWindow?r.scrollLeft:r.offset.left,t=m.left-p.collisionPosition.marginLeft;r=t-B;var u=t+p.collisionWidth-x-B;t="left"===p.my[0]?-p.elemWidth:"right"===p.my[0]?p.elemWidth:0;var y="left"===p.at[0]?p.targetWidth:"right"===p.at[0]?-p.targetWidth:0,v=-2*p.offset[0];if(0>r){if(p=m.left+t+y+v+p.collisionWidth-x-w,0>p||p<e(r))m.left+=t+y+v}else 0<u&&(p=m.left-p.collisionPosition.marginLeft+t+y+v-B,0<p||e(p)<u)&&
(m.left+=t+y+v)},top:function(m,p){var r=p.within,w=r.offset.top+r.scrollTop,x=r.height,B=r.isWindow?r.scrollTop:r.offset.top,t=m.top-p.collisionPosition.marginTop;r=t-B;var u=t+p.collisionHeight-x-B;t="top"===p.my[1]?-p.elemHeight:"bottom"===p.my[1]?p.elemHeight:0;var y="top"===p.at[1]?p.targetHeight:"bottom"===p.at[1]?-p.targetHeight:0,v=-2*p.offset[1];if(0>r){if(p=m.top+t+y+v+p.collisionHeight-x-w,0>p||p<e(r))m.top+=t+y+v}else 0<u&&(p=m.top-p.collisionPosition.marginTop+t+y+v-B,0<p||e(p)<u)&&(m.top+=
t+y+v)}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,arguments)}}}})();return a.ui.position});
...
4-(k.getDay()||7));f=k.getTime();k.setMonth(0);k.setDate(1);return Math.floor(Math.round((f-k)/864E5)/7)+1},parseDate:function(f,k,q){if(null==f||null==k)throw"Invalid arguments";k="object"===typeof k?k.toString():k+"";if(""===k)return null;var l,n=0;var m=(q?q.shortYearCutoff:null)||this._defaults.shortYearCutoff;m="string"!==typeof m?m:(new Date).getFullYear()%100+parseInt(m,10);var p=(q?q.dayNamesShort:null)||this._defaults.dayNamesShort;var r=(q?q.dayNames:null)||this._defaults.dayNames,w=(q?
q.monthNamesShort:null)||this._defaults.monthNamesShort,x=(q?q.monthNames:null)||this._defaults.monthNames,B=q=-1,t=-1,u=-1,y=!1,v=function(F){(F=l+1<f.length&&f.charAt(l+1)===F)&&l++;return F},C=function(F){var E=v(F);E="@"===F?14:"!"===F?20:"y"===F&&E?4:"o"===F?3:2;F=new RegExp("^\\d{"+("y"===F?E:1)+","+E+"}");F=k.substring(n).match(F);if(!F)throw"Missing number at position "+n;n+=F[0].length;return parseInt(F[0],10)},A=function(F,E,G){var I=-1;F=a.map(v(F)?G:E,function(H,J){return[[J,H]]}).sort(function(H,
J){return-(H[1].length-J[1].length)});a.each(F,function(H,J){H=J[1];if(k.substr(n,H.length).toLowerCase()===H.toLowerCase())return I=J[0],n+=H.length,!1});if(-1!==I)return I+1;throw"Unknown name at position "+n;},z=function(){if(k.charAt(n)!==f.charAt(l))throw"Unexpected literal at position "+n;n++};for(l=0;l<f.length;l++)if(y)"'"!==f.charAt(l)||v("'")?z():y=!1;else switch(f.charAt(l)){case "d":t=C("d");break;case "D":A("D",p,r);break;case "o":u=C("o");break;case "m":B=C("m");break;case "M":B=A("M",
w,x);break;case "y":q=C("y");break;case "@":var D=new Date(C("@"));q=D.getFullYear();B=D.getMonth()+1;t=D.getDate();break;case "!":D=new Date((C("!")-this._ticksTo1970)/1E4);q=D.getFullYear();B=D.getMonth()+1;t=D.getDate();break;case "'":v("'")?z():y=!0;break;default:z()}if(n<k.length&&(p=k.substr(n),!/^\s+/.test(p)))throw"Extra/unparsed characters found in date: "+p;-1===q?q=(new Date).getFullYear():100>q&&(q+=(new Date).getFullYear()-(new Date).getFullYear()%100+(q<=m?0:-100));if(-1<u){B=1;t=u;
...
null)||this._defaults.dayNamesShort,m=(q?q.dayNames:null)||this._defaults.dayNames,p=(q?q.monthNamesShort:null)||this._defaults.monthNamesShort;q=(q?q.monthNames:null)||this._defaults.monthNames;var r=function(u){(u=l+1<f.length&&f.charAt(l+1)===u)&&l++;return u},w=function(u,y,v){y=""+y;if(r(u))for(;y.length<v;)y="0"+y;return y},x=function(u,y,v,C){return r(u)?C[y]:v[y]},B="",t=!1;if(k)for(l=0;l<f.length;l++)if(t)"'"!==f.charAt(l)||r("'")?B+=f.charAt(l):t=!1;else switch(f.charAt(l)){case "d":B+=
w("d",k.getDate(),2);break;case "D":B+=x("D",k.getDay(),n,m);break;case "o":B+=w("o",Math.round(((new Date(k.getFullYear(),k.getMonth(),k.getDate())).getTime()-(new Date(k.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":B+=w("m",k.getMonth()+1,2);break;case "M":B+=x("M",k.getMonth(),p,q);break;case "y":B+=r("y")?k.getFullYear():(10>k.getFullYear()%100?"0":"")+k.getFullYear()%100;break;case "@":B+=k.getTime();break;case "!":B+=1E4*k.getTime()+this._ticksTo1970;break;case "'":r("'")?B+="'":
...
this._get(f,"defaultDate"),new Date))},_determineDate:function(f,k,q){var l=function(m){var p=new Date;p.setDate(p.getDate()+m);return p},n=function(m){try{return a.datepicker.parseDate(a.datepicker._get(f,"dateFormat"),m,a.datepicker._getFormatConfig(f))}catch(t){}var p=(m.toLowerCase().match(/^c/)?a.datepicker._getDate(f):null)||new Date,r=p.getFullYear(),w=p.getMonth();p=p.getDate();for(var x=/([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,B=x.exec(m);B;){switch(B[2]||"d"){case "d":case "D":p+=parseInt(B[1],
10);break;case "w":case "W":p+=7*parseInt(B[1],10);break;case "m":case "M":w+=parseInt(B[1],10);p=Math.min(p,a.datepicker._getDaysInMonth(r,w));break;case "y":case "Y":r+=parseInt(B[1],10),p=Math.min(p,a.datepicker._getDaysInMonth(r,w))}B=x.exec(m)}return new Date(r,w,p)};if(k=(k=null==k||""===k?q:"string"===typeof k?n(k):"number"===typeof k?isNaN(k)?q:l(k):new Date(k.getTime()))&&"Invalid Date"===k.toString()?q:k)k.setHours(0),k.setMinutes(0),k.setSeconds(0),k.setMilliseconds(0);return this._daylightSavingAdjust(k)},
...
"isRTL");var r=this._get(f,"showButtonPanel");var w=this._get(f,"hideIfNoPrevNext");var x=this._get(f,"navigationAsDateFormat");var B=this._getNumberOfMonths(f),t=this._get(f,"showCurrentAtPos");var u=this._get(f,"stepMonths");var y=1!==B[0]||1!==B[1],v=this._daylightSavingAdjust(f.currentDay?new Date(f.currentYear,f.currentMonth,f.currentDay):new Date(9999,9,9)),C=this._getMinMaxDate(f,"min"),A=this._getMinMaxDate(f,"max");t=f.drawMonth-t;var z=f.drawYear;0>t&&(t+=12,z--);if(A){var D=this._daylightSavingAdjust(new Date(A.getFullYear(),
...
w?"":a("<a>").attr({"class":"ui-datepicker-prev ui-corner-all ui-state-disabled",title:D}).append(a("<span>").addClass("ui-icon ui-icon-circle-triangle-"+(p?"e":"w")).text(D))[0].outerHTML;var F=this._get(f,"nextText");F=x?this.formatDate(F,this._daylightSavingAdjust(new Date(z,t+u,1)),this._getFormatConfig(f)):F;w=this._canAdjustMonth(f,1,z,t)?a("<a>").attr({"class":"ui-datepicker-next ui-corner-all","data-handler":"next","data-event":"click",title:F}).append(a("<span>").addClass("ui-icon ui-icon-circle-triangle-"+
(p?"w":"e")).text(F))[0].outerHTML:w?"":a("<a>").attr({"class":"ui-datepicker-next ui-corner-all ui-state-disabled",title:F}).append(a("<span>").attr("class","ui-icon ui-icon-circle-triangle-"+(p?"w":"e")).text(F))[0].outerHTML;u=this._get(f,"currentText");F=this._get(f,"gotoCurrent")&&f.currentDay?v:m;u=x?this.formatDate(u,F,this._getFormatConfig(f)):u;var E="";f.inline||(E=a("<button>").attr({type:"button","class":"ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all","data-handler":"hide",
...
(p?"right":"left");break;case B[1]-1:Q+=" ui-datepicker-group-last";P=" ui-corner-"+(p?"left":"right");break;default:Q+=" ui-datepicker-group-middle",P=""}Q+="'>"}Q+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+P+"'>"+(/all|left/.test(P)&&0===k?p?w:D:"")+(/all|right/.test(P)&&0===k?p?D:w:"")+this._generateMonthYearHeader(f,t,z,C,A,0<k||0<q,G,I)+"</div><table class='ui-datepicker-calendar'><thead><tr>";var U=u?"<th class='ui-datepicker-week-col'>"+this._get(f,"weekHeader")+
...
v.getTime()?" "+this._currentClass:"")+(N.getTime()===m.getTime()?" ui-datepicker-today":""))+"'"+(n&&!J||!da[2]?"":" title='"+da[2].replace(/'/g,"&#39;")+"'")+(ha?"":" data-handler='selectDay' data-event='click' data-month='"+N.getMonth()+"' data-year='"+N.getFullYear()+"'")+">"+(n&&!J?"&#xa0;":ha?"<span class='ui-state-default'>"+N.getDate()+"</span>":"<a class='ui-state-default"+(N.getTime()===m.getTime()?" ui-state-highlight":"")+(N.getTime()===v.getTime()?" ui-state-active":"")+(n?" ui-priority-secondary":
"")+"' href='#' aria-current='"+(N.getTime()===v.getTime()?"true":"false")+"' data-date='"+N.getDate()+"'>"+N.getDate()+"</a>")+"</td>";N.setDate(N.getDate()+1);N=this._daylightSavingAdjust(N)}Q+=ca+"</tr>"}t++;11<t&&(t=0,z++);Q+="</tbody></table>"+(y?"</div>"+(0<B[0]&&q===B[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");L+=Q}S+=L}f._keyEvent=!1;return S+x},_generateMonthYearHeader:function(f,k,q,l,n,m,p,r){var w=this._get(f,"changeMonth"),x=this._get(f,"changeYear"),B=this._get(f,"showMonthAfterYear");
var t=this._get(f,"selectMonthLabel");var u=this._get(f,"selectYearLabel"),y="<div class='ui-datepicker-title'>",v="";if(m||!w)v+="<span class='ui-datepicker-month'>"+p[k]+"</span>";else{p=l&&l.getFullYear()===q;var C=n&&n.getFullYear()===q;v+="<select class='ui-datepicker-month' aria-label='"+t+"' data-handler='selectMonth' data-event='change'>";for(t=0;12>t;t++)(!p||t>=l.getMonth())&&(!C||t<=n.getMonth())&&(v+="<option value='"+t+"'"+(t===k?" selected='selected'":"")+">"+r[t]+"</option>");v+="</select>"}B||
(y+=v+(!m&&w&&x?"":"&#xa0;"));if(!f.yearshtml)if(f.yearshtml="",m||!x)y+="<span class='ui-datepicker-year'>"+q+"</span>";else{r=this._get(f,"yearRange").split(":");var A=(new Date).getFullYear();p=function(z){z=z.match(/c[+\-].*/)?q+parseInt(z.substring(1),10):z.match(/[+\-].*/)?A+parseInt(z,10):parseInt(z,10);return isNaN(z)?A:z};k=p(r[0]);r=Math.max(k,p(r[1]||""));k=l?Math.max(k,l.getFullYear()):k;r=n?Math.min(r,n.getFullYear()):r;for(f.yearshtml+="<select class='ui-datepicker-year' aria-label='"+
u+"' data-handler='selectYear' data-event='change'>";k<=r;k++)f.yearshtml+="<option value='"+k+"'"+(k===q?" selected='selected'":"")+">"+k+"</option>";f.yearshtml+="</select>";y+=f.yearshtml;f.yearshtml=null}y+=this._get(f,"yearSuffix");B&&(y+=(!m&&w&&x?"":"&#xa0;")+v);return y+"</div>"},_adjustInstDate:function(f,k,q){var l=f.selectedYear+("Y"===q?k:0),n=f.selectedMonth+("M"===q?k:0);k=Math.min(f.selectedDay,this._getDaysInMonth(l,n))+("D"===q?k:0);l=this._restrictMinMax(f,this._daylightSavingAdjust(new Date(l,
...
g.options.snap.release.call(g.element,b,a.extend(g._uiHash(),{snapItem:g.snapElements[c].item})),g.snapElements[c].snapping=!1;else{if("inner"!==e.snapMode){var w=Math.abs(p-l)<=h;var x=Math.abs(r-q)<=h;var B=Math.abs(n-k)<=h;var t=Math.abs(m-f)<=h;w&&(d.position.top=g._convertPositionTo("relative",{top:p-g.helperProportions.height,left:0}).top);x&&(d.position.top=g._convertPositionTo("relative",{top:r,left:0}).top);B&&(d.position.left=g._convertPositionTo("relative",{top:0,left:n-g.helperProportions.width}).left);
t&&(d.position.left=g._convertPositionTo("relative",{top:0,left:m}).left)}var u=w||x||B||t;"outer"!==e.snapMode&&(w=Math.abs(p-q)<=h,x=Math.abs(r-l)<=h,B=Math.abs(n-f)<=h,t=Math.abs(m-k)<=h,w&&(d.position.top=g._convertPositionTo("relative",{top:p,left:0}).top),x&&(d.position.top=g._convertPositionTo("relative",{top:r-g.helperProportions.height,left:0}).top),B&&(d.position.left=g._convertPositionTo("relative",{top:0,left:n}).left),t&&(d.position.left=g._convertPositionTo("relative",{top:0,left:m-
g.helperProportions.width}).left));!g.snapElements[c].snapping&&(w||x||B||t||u)&&g.options.snap.snap&&g.options.snap.snap.call(g.element,b,a.extend(g._uiHash(),{snapItem:g.snapElements[c].item}));g.snapElements[c].snapping=w||x||B||t||u}}}});a.ui.plugin.add("draggable","stack",{start:function(b,d,g){b=a.makeArray(a(g.options.stack)).sort(function(e,h){return(parseInt(a(e).css("zIndex"),10)||0)-(parseInt(a(h).css("zIndex"),10)||0)});if(b.length){var c=parseInt(a(b[0]).css("zIndex"),10)||0;a(b).each(function(e){a(this).css("zIndex",
...
var n=1==this._get(c,"showMinutes"),m=this._get(c,"amPmText"),p=this._get(c,"rows"),r=0,w=0,x=h=0,B=0,t=0,u=[],y=this._get(c,"hours"),v=0;var C=this._get(c,"hourText");var A=this._get(c,"showCloseButton"),z=this._get(c,"closeButtonText"),D=this._get(c,"showNowButton"),F=this._get(c,"nowButtonText"),E=this._get(c,"showDeselectButton"),G=this._get(c,"deselectButtonText"),I=A||D||E;for(e=y.starts;e<=y.ends;e++)u.push(e);e=Math.ceil(u.length/p);if(k){for(v=0;v<u.length;v++)12>u[v]?h++:x++;v=0;r=Math.floor(h/
u.length*p);w=Math.floor(x/u.length*p);p!=r+w&&(h&&(!x||!r||w&&h/r>=x/w)?r++:w++);B=Math.min(r,1);t=r+1;e=0==r?Math.ceil(x/w):0==w?Math.ceil(h/r):Math.ceil(Math.max(h/r,x/w))}h='<table class="ui-timepicker-table ui-widget-content ui-corner-all"><tr>';if(l){h+='<td class="ui-timepicker-hours"><div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+C+'</div><table class="ui-timepicker">';for(l=1;l<=p;l++){h+="<tr>";l==B&&k&&(h+='<th rowspan="'+r.toString()+'" class="periods" scope="row">'+
m[0]+"</th>");l==t&&k&&(h+='<th rowspan="'+w.toString()+'" class="periods" scope="row">'+m[1]+"</th>");for(C=1;C<=e;C++)k&&l<t&&12<=u[v]?h+=this._generateHTMLHourCell(c,void 0,f,q):(h+=this._generateHTMLHourCell(c,u[v],f,q),v++);h+="</tr>"}h+="</table></td>"}n&&(h=h+'<td class="ui-timepicker-minutes">'+this._generateHTMLMinutes(c),h+="</td>");h+="</tr>";I&&(f='<tr><td colspan="3"><div class="ui-timepicker-buttonpane ui-widget-content">',D&&(f+='<button type="button" class="ui-timepicker-now ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+
...
k.push(e);k.sort(function(w,x){return w-x});l=Math.round(k.length/f+.49);if(p&&0==p.apply(c.input?c.input[0]:null,[c.hours,c.minutes]))for(n=0;n<k.length;n+=1)if(e=k[n],p.apply(c.input?c.input[0]:null,[c.hours,e])){c.minutes=e;break}h+='<div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+r+'</div><table class="ui-timepicker">';n=0;for(q=1;q<=f;q++){for(h+="<tr>";n<q*l;)e=k[n],p="",void 0!==e&&(p=10>e&&m?"0"+e.toString():e.toString()),h+=this._generateHTMLMinuteCell(c,
...
formattedTime:"",formattedDateTime:"",timezoneList:null,units:["hour","minute","second","millisec","microsec"],support:{},control:null,setDefaults:function(l){g(this._defaults,l||{});return this},_newInst:function(l,n){var m=new b,p={},r={};for(x in this._defaults)if(this._defaults.hasOwnProperty(x)){var w=l.attr("time:"+x);if(w)try{p[x]=eval(w)}catch(t){p[x]=w}}var x={beforeShow:function(t,u){if(a.isFunction(m._defaults.evnts.beforeShow))return m._defaults.evnts.beforeShow.call(l[0],t,u,m)},onChangeMonthYear:function(t,
...
if(!l)return!1;a.extend(this,l)}return!0},_afterInject:function(){var l=this.inst.settings;a.isFunction(l.afterInject)&&l.afterInject.call(this)},_injectTimePicker:function(){var l=this.inst.dpDiv,n=this.inst.settings,m=this,p="",r="",w=null,x={},B={},t=null,u=0,y=0;if(0===l.find("div.ui-timepicker-div").length&&n.showTimepicker){t='<div class="ui-timepicker-div'+(n.isRTL?" ui-timepicker-rtl":"")+(n.oneLine&&"select"===n.controlType?" ui-timepicker-oneLine":"")+'"><dl><dt class="ui_tpicker_time_label'+
(n.showTime?"":" ui_tpicker_unit_hide")+'">'+n.timeText+'</dt><dd class="ui_tpicker_time '+(n.showTime?"":" ui_tpicker_unit_hide")+'"><input class="ui_tpicker_time_input" '+(n.timeInput?"":"disabled")+"/></dd>";u=0;for(y=this.units.length;u<y;u++){p=this.units[u];r=p.substr(0,1).toUpperCase()+p.substr(1);w=null!==n["show"+r]?n["show"+r]:this.support[p];x[p]=parseInt(n[p+"Max"]-(n[p+"Max"]-n[p+"Min"])%n["step"+r],10);B[p]=0;t+='<dt class="ui_tpicker_'+p+"_label"+(w?"":" ui_tpicker_unit_hide")+'">'+
n[p+"Text"]+'</dt><dd class="ui_tpicker_'+p+(w?"":" ui_tpicker_unit_hide")+'"><div class="ui_tpicker_'+p+"_slider"+(w?"":" ui_tpicker_unit_hide")+'"></div>';if(w&&0<n[p+"Grid"]){t+='<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>';if("hour"===p)for(r=n[p+"Min"];r<=x[p];r+=parseInt(n[p+"Grid"],10))B[p]++,w=a.datepicker.formatTime(this.support.ampm?"hht":"HH",{hour:r},n),t+='<td data-for="'+p+'">'+w+"</td>";else for(r=n[p+"Min"];r<=x[p];r+=parseInt(n[p+"Grid"],10))B[p]++,t+=
'<td data-for="'+p+'">'+(10>r?"0":"")+r+"</td>";t+="</tr></table></div>"}t+="</dd>"}u=null!==n.showTimezone?n.showTimezone:this.support.timezone;t+='<dt class="ui_tpicker_timezone_label'+(u?"":" ui_tpicker_unit_hide")+'">'+n.timezoneText+"</dt>";var v=a(t+('<dd class="ui_tpicker_timezone'+(u?"":" ui_tpicker_unit_hide")+'"></dd></dl></div>'));!0===n.timeOnly&&(v.prepend('<div class="ui-widget-header ui-helper-clearfix ui-corner-all"><div class="ui-datepicker-title">'+n.timeOnlyTitle+"</div></div>"),
l.find(".ui-datepicker-header, .ui-datepicker-calendar").hide());u=0;for(y=m.units.length;u<y;u++)p=m.units[u],r=p.substr(0,1).toUpperCase()+p.substr(1),w=null!==n["show"+r]?n["show"+r]:this.support[p],m[p+"_slider"]=m.control.create(m,v.find(".ui_tpicker_"+p+"_slider"),p,m[p],n[p+"Min"],x[p],n["step"+r]),w&&0<n[p+"Grid"]&&(t=100*B[p]*n[p+"Grid"]/(x[p]-n[p+"Min"]),v.find(".ui_tpicker_"+p+" table").css({width:t+"%",marginLeft:n.isRTL?"0":t/(-2*B[p])+"%",marginRight:n.isRTL?t/(-2*B[p])+"%":"0",borderCollapse:"collapse"}).find("td").click(function(z){var D=
a(this),F=D.html();z=parseInt(F.replace(/[^0-9]/g),10);F=F.replace(/[^apm]/ig);D=D.data("for");"hour"===D&&(-1!==F.indexOf("p")&&12>z?z+=12:-1!==F.indexOf("a")&&12===z&&(z=0));m.control.value(m,m[D+"_slider"],p,z);m._onTimeChange();m._onSelectHandler()}).css({cursor:"pointer",width:100/B[p]+"%",textAlign:"center",overflow:"hidden"}));this.timezone_select=v.find(".ui_tpicker_timezone").append("<select></select>").find("select");a.fn.append.apply(this.timezone_select,a.map(n.timezoneList,function(z,
...
m._onSelectHandler();m._afterInject()});n=l.find(".ui-datepicker-buttonpane");n.length?n.before(v):l.append(v);this.$timeObj=v.find(".ui_tpicker_time_input");this.$timeObj.change(function(){var z=a.datepicker.parseTime(m.inst.settings.timeFormat,this.value),D=new Date;z?(D.setHours(z.hour),D.setMinutes(z.minute),D.setSeconds(z.second),a.datepicker._setTime(m.inst,D)):(this.value=m.formattedTime,this.blur())});null!==this.inst&&(l=this.timeDefined,this._onTimeChange(),this.timeDefined=l);if(this._defaults.addSliderAccess){var C=
this._defaults.sliderAccessArgs,A=this._defaults.isRTL;C.isRTL=A;setTimeout(function(){if(0===v.find(".ui-slider-access").length){v.find(".ui-slider:visible").sliderAccess(C);var z=v.find(".ui-slider-access:eq(0)").outerWidth(!0);z&&v.find("table:visible").each(function(){var D=a(this),F=D.outerWidth(),E=D.css(A?"marginRight":"marginLeft").toString().replace("%",""),G=F-z,I={width:G,marginRight:0,marginLeft:0};I[A?"marginRight":"marginLeft"]=E*G/F+"%";D.css(I)})}},10)}m._limitMinMaxDateTime(this.inst,
!0)}},_limitMinMaxDateTime:function(l,n){var m=this._defaults,p=new Date(l.selectedYear,l.selectedMonth,l.selectedDay);if(this._defaults.showTimepicker){if(null!==a.datepicker._get(l,"minDateTime")&&void 0!==a.datepicker._get(l,"minDateTime")&&p){var r=a.datepicker._get(l,"minDateTime"),w=new Date(r.getFullYear(),r.getMonth(),r.getDate(),0,0,0,0);if(null===this.hourMinOriginal||null===this.minuteMinOriginal||null===this.secondMinOriginal||null===this.millisecMinOriginal||null===this.microsecMinOriginal)this.hourMinOriginal=
m.hourMin,this.minuteMinOriginal=m.minuteMin,this.secondMinOriginal=m.secondMin,this.millisecMinOriginal=m.millisecMin,this.microsecMinOriginal=m.microsecMin;l.settings.timeOnly||w.getTime()===p.getTime()?(this._defaults.hourMin=r.getHours(),this.hour<=this._defaults.hourMin?(this.hour=this._defaults.hourMin,this._defaults.minuteMin=r.getMinutes(),this.minute<=this._defaults.minuteMin?(this.minute=this._defaults.minuteMin,this._defaults.secondMin=r.getSeconds(),this.second<=this._defaults.secondMin?
...
this._defaults.microsecMin=this.microsecMinOriginal)}if(null!==a.datepicker._get(l,"maxDateTime")&&void 0!==a.datepicker._get(l,"maxDateTime")&&p){r=a.datepicker._get(l,"maxDateTime");w=new Date(r.getFullYear(),r.getMonth(),r.getDate(),0,0,0,0);if(null===this.hourMaxOriginal||null===this.minuteMaxOriginal||null===this.secondMaxOriginal||null===this.millisecMaxOriginal)this.hourMaxOriginal=m.hourMax,this.minuteMaxOriginal=m.minuteMax,this.secondMaxOriginal=m.secondMax,this.millisecMaxOriginal=m.millisecMax,
this.microsecMaxOriginal=m.microsecMax;l.settings.timeOnly||w.getTime()===p.getTime()?(this._defaults.hourMax=r.getHours(),this.hour>=this._defaults.hourMax?(this.hour=this._defaults.hourMax,this._defaults.minuteMax=r.getMinutes(),this.minute>=this._defaults.minuteMax?(this.minute=this._defaults.minuteMax,this._defaults.secondMax=r.getSeconds(),this.second>=this._defaults.secondMax?(this.second=this._defaults.secondMax,this._defaults.millisecMax=r.getMilliseconds(),this.millisec>=this._defaults.millisecMax?
...
"hour"):!1,n=this.minute_slider?this.control.value(this,this.minute_slider,"minute"):!1,m=this.second_slider?this.control.value(this,this.second_slider,"second"):!1,p=this.millisec_slider?this.control.value(this,this.millisec_slider,"millisec"):!1,r=this.microsec_slider?this.control.value(this,this.microsec_slider,"microsec"):!1,w=this.timezone_select?this.timezone_select.val():!1,x=this._defaults,B=x.pickerTimeFormat||x.timeFormat,t=x.pickerTimeSuffix||x.timeSuffix;"object"===typeof l&&(l=!1);"object"===
typeof n&&(n=!1);"object"===typeof m&&(m=!1);"object"===typeof p&&(p=!1);"object"===typeof r&&(r=!1);"object"===typeof w&&(w=!1);!1!==l&&(l=parseInt(l,10));!1!==n&&(n=parseInt(n,10));!1!==m&&(m=parseInt(m,10));!1!==p&&(p=parseInt(p,10));!1!==r&&(r=parseInt(r,10));!1!==w&&(w=w.toString());var u=x[12>l?"amNames":"pmNames"][0],y=l!==parseInt(this.hour,10)||n!==parseInt(this.minute,10)||m!==parseInt(this.second,10)||p!==parseInt(this.millisec,10)||r!==parseInt(this.microsec,10)||0<this.ampm.length&&12>
l!==(-1!==a.inArray(this.ampm.toUpperCase(),this.amNames))||null!==this.timezone&&w!==this.timezone.toString();y&&(!1!==l&&(this.hour=l),!1!==n&&(this.minute=n),!1!==m&&(this.second=m),!1!==p&&(this.millisec=p),!1!==r&&(this.microsec=r),!1!==w&&(this.timezone=w),this.inst||(this.inst=a.datepicker._getInst(this.$input[0])),this._limitMinMaxDateTime(this.inst,!0));this.support.ampm&&(this.ampm=u);this.formattedTime=a.datepicker.formatTime(x.timeFormat,this,x);this.$timeObj&&(B===x.timeFormat?this.$timeObj.val(this.formattedTime+
...
this._defaults.defaultValue){this.$input.val(this._defaults.defaultValue);var l=a.datepicker._getInst(this.$input.get(0)),n=a.datepicker._get(l,"timepicker");if(n&&n._defaults.timeOnly&&l.input.val()!==l.lastVal)try{a.datepicker._updateDatepicker(l)}catch(m){a.timepicker.log(m)}}},_controls:{slider:{create:function(l,n,m,p,r,w,x){var B=l._defaults.isRTL;return n.prop("slide",null).slider({orientation:"horizontal",value:B?-1*p:p,min:B?-1*w:r,max:B?-1*r:w,step:x,slide:function(t,u){l.control.value(l,
...
-1*p):Math.abs(n.slider("value")):void 0!==p?n.slider("value",p):n.slider("value")}},select:{create:function(l,n,m,p,r,w,x){for(var B='<select class="ui-timepicker-select ui-state-default ui-corner-all" data-unit="'+m+'" data-min="'+r+'" data-max="'+w+'" data-step="'+x+'">',t=l._defaults.pickerTimeFormat||l._defaults.timeFormat;r<=w;r+=x)B+='<option value="'+r+'"'+(r===p?" selected":"")+">",B="hour"===m?B+a.datepicker.formatTime(a.trim(t.replace(/[^ht ]/ig,"")),{hour:r},l._defaults):"millisec"===
m||"microsec"===m||10<=r?B+r:B+("0"+r.toString()),B+="</option>";B+="</select>";n.children("select").remove();a(B).appendTo(n).change(function(u){l._onTimeChange();l._onSelectHandler();l._afterInject()});return n},options:function(l,n,m,p,r){m={};var w=n.children("select");if("string"===typeof p){if(void 0===r)return w.data(p);m[p]=r}else m=p;return l.control.create(l,n,w.data("unit"),w.val(),0<=m.min?m.min:w.data("min"),m.max||w.data("max"),m.step||w.data("step"))},value:function(l,n,m,p){l=n.children("select");
...
a(this);m.datepicker(a.timepicker._newInst(m,l)._defaults)})}});a.datepicker.parseDateTime=function(l,n,m,p,r){l=k(l,n,m,p,r);l.timeObj&&(n=l.timeObj,l.date.setHours(n.hour,n.minute,n.second,n.millisec),l.date.setMicroseconds(n.microsec));return l.date};a.datepicker.parseTime=function(l,n,m){m=g(g({},a.timepicker._defaults),m||{});l.replace(/'.*?'/g,"").indexOf("Z");var p=function(w,x,B){var t=function(v,C){var A=[];v&&a.merge(A,v);C&&a.merge(A,C);A=a.map(A,function(z){return z.replace(/[.*+?|()\[\]{}\\]/g,
"\\$&")});return"("+A.join("|")+")?"},u="^"+w.toString().replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g,function(v){var C=v.length;switch(v.charAt(0).toLowerCase()){case "h":return 1===C?"(\\d?\\d)":"(\\d{"+C+"})";case "m":return 1===C?"(\\d?\\d)":"(\\d{"+C+"})";case "s":return 1===C?"(\\d?\\d)":"(\\d{"+C+"})";case "l":return"(\\d?\\d?\\d)";case "c":return"(\\d?\\d?\\d)";case "z":return"(z|[-+]\\d\\d:?\\d\\d|\\S+)?";case "t":return t(B.amNames,B.pmNames);default:return"("+v.replace(/'/g,
"").replace(/(\.|\$|\^|\\|\/|\(|\)|\[|\]|\?|\+|\*)/g,function(A){return"\\"+A})+")?"}}).replace(/\s/g,"\\s?")+B.timeSuffix+"$";w=function(v){v=v.toLowerCase().match(/(h{1,2}|m{1,2}|s{1,2}|l{1}|c{1}|t{1,2}|z|'.*?')/g);var C={h:-1,m:-1,s:-1,l:-1,c:-1,t:-1,z:-1};if(v)for(var A=0;A<v.length;A++)-1===C[v[A].toString().charAt(0)]&&(C[v[A].toString().charAt(0)]=A+1);return C}(w);var y="";x=x.match(new RegExp(u,"i"));u={hour:0,minute:0,second:0,millisec:0,microsec:0};return x?(-1!==w.t&&(void 0===x[w.t]||
0===x[w.t].length?(y="",u.ampm=""):(y=-1!==a.inArray(x[w.t].toUpperCase(),a.map(B.amNames,function(v,C){return v.toUpperCase()}))?"AM":"PM",u.ampm=B["AM"===y?"amNames":"pmNames"][0])),-1!==w.h&&(u.hour="AM"===y&&"12"===x[w.h]?0:"PM"===y&&"12"!==x[w.h]?parseInt(x[w.h],10)+12:Number(x[w.h])),-1!==w.m&&(u.minute=Number(x[w.m])),-1!==w.s&&(u.second=Number(x[w.s])),-1!==w.l&&(u.millisec=Number(x[w.l])),-1!==w.c&&(u.microsec=Number(x[w.c])),-1!==w.z&&void 0!==x[w.z]&&(u.timezone=a.timepicker.timezoneOffsetNumber(x[w.z])),
u):!1},r=function(w,x,B){try{var t=new Date("2012-01-01 "+x);if(isNaN(t.getTime())&&(t=new Date("2012-01-01T"+x),isNaN(t.getTime())&&(t=new Date("01/01/2012 "+x),isNaN(t.getTime()))))throw"Unable to parse time with native Date: "+x;return{hour:t.getHours(),minute:t.getMinutes(),second:t.getSeconds(),millisec:t.getMilliseconds(),microsec:t.getMicroseconds(),timezone:-1*t.getTimezoneOffset()}}catch(u){try{return p(w,x,B)}catch(y){a.timepicker.log("Unable to parse \ntimeString: "+x+"\ntimeFormat: "+
w)}}return!1};return"function"===typeof m.parse?m.parse(l,n,m):"loose"===m.parse?r(l,n,m):p(l,n,m)};a.datepicker.formatTime=function(l,n,m){m=m||{};m=a.extend({},a.timepicker._defaults,m);n=a.extend({hour:0,minute:0,second:0,millisec:0,microsec:0,timezone:null},n);var p=m.amNames[0],r=parseInt(n.hour,10);11<r&&(p=m.pmNames[0]);return l=l.replace(/(?:HH?|hh?|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g,function(w){switch(w){case "HH":return("0"+r).slice(-2);case "H":return r;case "hh":return("0"+e(r)).slice(-2);
...
p.getTime()||(this._base_setDateDatepicker.apply(this,arguments),p=a(l).datepicker("getDate")));var r=this._get(m,"timepicker");if(p instanceof Date){var w=new Date(p.getTime());w.setMicroseconds(p.getMicroseconds())}else w=p;r&&w&&(r.support.timezone||null!==r._defaults.timezone||(r.timezone=-1*w.getTimezoneOffset()),a.timepicker.timezoneAdjust(p,a.timepicker.timezoneOffsetString(-p.getTimezoneOffset()),r.timezone),w=a.timepicker.timezoneAdjust(w,a.timepicker.timezoneOffsetString(-w.getTimezoneOffset()),
r.timezone));this._updateDatepicker(m);this._base_setDateDatepicker.apply(this,arguments);this._setTimeDatepicker(l,w,!0)}};a.datepicker._base_getDateDatepicker=a.datepicker._getDateDatepicker;a.datepicker._getDateDatepicker=function(l,n){var m=this._getInst(l);if(m){var p=this._get(m,"timepicker");return p?(void 0===m.lastVal&&this._setDateFromField(m,n),l=this._getDate(m),n=p.$altInput&&p._defaults.altFieldTimeOnly?p.$input.val()+" "+p.$altInput.val():"INPUT"!==p.$input.get(0).tagName&&p.$altInput?
...
a.datepicker._optionDatepicker=function(l,n,m){var p=this._getInst(l);if(!p)return null;if(p=this._get(p,"timepicker")){var r=null,w=null,x=null,B=p._defaults.evnts,t={};if("string"===typeof n)if("minDate"===n||"minDateTime"===n)r=m;else if("maxDate"===n||"maxDateTime"===n)w=m;else if("onSelect"===n)x=m;else{if(B.hasOwnProperty(n)){if("undefined"===typeof m)return B[n];t[n]=m;var u={}}}else if("object"===typeof n)for(y in n.minDate?r=n.minDate:n.minDateTime?r=n.minDateTime:n.maxDate?w=n.maxDate:n.maxDateTime&&
(w=n.maxDateTime),B)B.hasOwnProperty(y)&&n[y]&&(t[y]=n[y]);for(y in t)t.hasOwnProperty(y)&&(B[y]=t[y],u||=a.extend({},n),delete u[y]);if(u&&d(u))return;r?(r=0===r?new Date:new Date(r),p._defaults.minDate=r,p._defaults.minDateTime=r):w?(w=0===w?new Date:new Date(w),p._defaults.maxDate=w,p._defaults.maxDateTime=w):x&&(p._defaults.onSelect=x);if(r||w){p=a(l);var y=p.datetimepicker("getDate");l=this._base_optionDatepicker.call(a.datepicker,l,u||n,m);p.datetimepicker("setDate",y);return l}}return void 0===
...
function(l,n,m){a.timepicker.handleRange("datepicker",l,n,m)};a.timepicker.handleRange=function(l,n,m,p){function r(B,t){var u=n[l]("getDate"),y=m[l]("getDate");B=B[l]("getDate");if(null!==u){var v=new Date(u.getTime()),C=new Date(u.getTime());v.setMilliseconds(v.getMilliseconds()+p.minInterval);C.setMilliseconds(C.getMilliseconds()+p.maxInterval);if(0<p.minInterval&&v>y)m[l]("setDate",v);else if(0<p.maxInterval&&C<y)m[l]("setDate",C);else if(u>y)t[l]("setDate",B)}}function w(B,t,u){B.val()&&(B=B[l].call(B,
"getDate"),null!==B&&0<p.minInterval&&("minDate"===u&&B.setMilliseconds(B.getMilliseconds()+p.minInterval),"maxDate"===u&&B.setMilliseconds(B.getMilliseconds()-p.minInterval)),B.getTime&&t[l].call(t,"option",u,B))}p=a.extend({},{minInterval:0,maxInterval:0,start:{},end:{}},p);var x=!1;"timepicker"===l&&(x=!0,l="datetimepicker");a.fn[l].call(n,a.extend({timeOnly:x,onClose:function(B,t){r(a(this),m)},onSelect:function(B){w(a(this),m,"minDate")}},p,p.start));a.fn[l].call(m,a.extend({timeOnly:x,onClose:function(B,
t){r(a(this),n)},onSelect:function(B){w(a(this),n,"maxDate")}},p,p.end));r(n,m);w(n,m,"minDate");w(m,n,"maxDate");return a([n.get(0),m.get(0)])};a.timepicker.log=function(){window.console&&window.console.log&&window.console.log.apply&&window.console.log.apply(window.console,Array.prototype.slice.call(arguments))};a.timepicker._util={_extendRemove:g,_isEmptyObject:d,_convert24to12:e,_detectSupport:c,_selectLocalTimezone:q,_computeEffectiveSetting:h,_splitDateTime:f,_parseDateTimeInternal:k};Date.prototype.getMicroseconds||
...
e.$header.find("li").last().find("a").trigger("focus")):e.close();break;case 27:e.close();break;case 38:case 40:case 37:case 39:e._traverse(h.which,this);break;case 13:case 32:a(this).find("input")[0].click();break;case 65:h.altKey&&e.checkAll();break;case 70:h.altKey&&e.flipAll();break;case 85:h.altKey&&e.uncheckAll()}}).on("click.multiselect","input",function(h){var f=a(this),k=this.value,q=this.checked,l=e.element,n=l.find("option"),m=l[0].multiple,p=e.$inputs,r=p.filter(":checked").length,w=e.options,
x=e.htmlAllowedFor("options")?"html":"text";x=f.parent().find("span")[x]();w=w.maxSelected;if(this.disabled||!1===e._trigger("click",h,{value:k,text:x,checked:q}))h.preventDefault();else{if(w&&q&&r>w)return!1!==e._trigger("maxselected",h,{labels:e.$labels,inputs:p})&&e.buttonMessage("<center><b>LIMIT OF "+(r-1)+" REACHED!</b></center>"),this.checked=!1,h.preventDefault(),!1;this.focus();f.prop("aria-selected",q);n.each(function(){this.selected=this.value===k?q:m&&this.selected});m||(e.$labels.removeClass("ui-state-active"),
...
this.$menu.height(),n=this.$checkboxes.outerHeight(!1)-this.$checkboxes.height();e=d(e,this.element,!0).px;h=Math.min(e,h)-q-l-n}else"size"===e.toLowerCase()&&(f=!0,k=this.element[0].size||k);var m="hidden",p=0,r=4,w=-1;this.$checkboxes.find("li:not(.ui-multiselect-optgroup),a").filter(":visible").each(function(){0>w&&(w=this.offsetTop);r=this.offsetTop+this.offsetHeight-w+4;if(f&&++p>=k||r>h)return m="auto",f||(r=h),!1});this.$checkboxes.css("overflow",m).height(r);this._savedMenuHeight=this.$menu.outerHeight(!1)}},
...
(k.msgNoRecords||"-")+"</option>");else{var n=k.fncPrep,m=null;if(n)try{m=n(f)}catch(t){}n=k.lookupField||"id";for(var p=k.fncRepresent,r,w,x,B=0;B<f.length;B++)r=f[B],w=r[n],0!==B||k.multiple||(l=w),x=p?p(r,m):r.name,r=r._tooltip?' title="'+r._tooltip+'"':"",q.push("<option"+r+' value="'+w+'">'+x+"</option>");k.optional&&(l=0,q.unshift('<option value=""></option>'))}return{options:q.join(""),defaultValue:l}},e=function(f,k,q,l,n){var m=!1;if(1<f.length)if("checkbox"==f.first().attr("type")){if(f.first().closest(".checkboxes-widget-s3")){s3_debug("filterOptionsS3 error: checkboxes-widget-s3 not supported, skipping");
...
k);else{if(l.lookupURL)p=l.lookupURL,q&&(p=p.concat(q));else if(p=S3.Ap.concat("/",l.lookupPrefix,"/",r,".json"),q){var w=r+"."+k+"="+q;p=-1!=p.indexOf("?")?p.concat("&"+w):p.concat("?"+w)}if(w=l.tooltip)w="tooltip="+w,p=-1!=p.indexOf("?")?p.concat("&"+w):p.concat("?"+w);if((w=l.represent)||"undefined"==typeof w)p=-1!=p.indexOf("?")?p.concat("&represent=1"):p.concat("?represent=1");w=null;if(l.getWidgetHTML){w=l.targetWidget||f.attr("name");var x=$('[name = "'+w+'"]');w=!0;var B=!1;if(w=x.hasClass("groupedopts-widget")?
x.groupedopts("visible"):x.data("visible")||x.is(":visible"))B=!0,x.data("visible",!0),x.hasClass("groupedopts-widget")?x.groupedopts("hide"):x.hide(),b(x,r);w=$.ajaxS3({url:p,dataType:"html",success:function(t){var u=x;if(""!==t){var y=!1,v=!1;u.hasClass("groupedopts-widget")?y=!0:u.hasClass("multiselect-widget")&&(v=!0);var C;(y||v)&&"select"==u.prop("tagName").toLowerCase()&&(C=u.val());u.html(t).trigger("change").prop("disabled",!1);if(y||v){if(C){t=[];v=0;for(var A=C.length,z;v<A;v++)z=C[v],
...
t.data("visible")||t.is(":visible"))?(t.data("visible",!0),t.hasClass("groupedopts-widget")?t.groupedopts("hide"):t.hasClass("groupedopts-widget")?t.multiselect("hide"):t.hide(),b(t,r)):t.data("visible",!1)}),w=$.ajaxS3({url:p,dataType:"json",success:function(t){var u=c(t,l),y=0===t.length?!0:!1;f.each(function(){var v=$(this);a:if(v.hasClass("checkboxes-widget-s3"))s3_debug("filterOptionsS3 error: checkboxes-widget-s3 not supported, updateOptions aborted"),v=void 0;else{var C=u.options,A=u.defaultValue,
z=[];if(!y){var D;if(v.hasClass("checkboxes-widget-s3")){v=void 0;break a}else{(D=v.val())||(D=v.prop("value"));D||=v.data("selected");Array.isArray(D)||(D=D?[D]:[]);for(var F=0,E=D.length,G;F<E;F++)(G=D[F])&&$(C).filter("option[value="+G+"]").length&&z.push(G)}z.length&&(A=z)}"INPUT"==v.prop("tagName")&&(z=$("<select>").addClass(v.attr("class")).attr("id",v.attr("id")).attr("name",v.attr("name")).data("visible",v.data("visible")).hide(),v.replaceWith(z),v=z);z=""===C;v.html(C).val(A).trigger("change").prop("disabled",
z);v.hasClass("groupedopts-widget")?v.groupedopts("refresh"):v.hasClass("multiselect-widget")&&(v.multiselect("refresh"),z?v.multiselect("disable"):v.multiselect("enable"))}v.data("visible")&&(v.hasClass("groupedopts-widget")?y||v.groupedopts("show"):v.show());d(v,r)});g(r,k,q);n||S3ClearNavigateAwayConfirm()}});m.data("update-request",w)}},h=function(f){var k="";if("checkbox"==f.attr("type")){var q=f.closest(".checkboxes-widget-s3");q&&(f=q)}if(f.hasClass("checkboxes-widget-s3"))k=[],f.find("input:checked").each(function(){k.push($(this).val())});
else if(f.hasClass("s3-hierarchy-input")){if(k="",q=f.val())q=JSON.parse(q),q.constructor===Array?q.length&&(k=q[0]):q&&(k=q)}else 1==f.length&&(k=f.val());return[f,k]};$.filterOptionsS3=function(f){var k=f.trigger;k=f.event?f.event:"string"==typeof k?k:k.name;var q=f.lookupKey||k,l=a(f.trigger),n=a(f.target);if(n){var m=$(n);if(m.length){void 0!==m.attr("multiple")&&(f.multiple=!0);var p=m.closest("form");if(l&&(m=p.find(l),m.length)){$(l).each(function(){var w=$(this);var x=w.closest(".inline-form");
if(!x.length||!x.hasClass("empty-row")&&"none"!=x.css("display"))x="row"==f.scope?w.closest(".edit-row.inline-form,.add-row.inline-form"):p,w=h(w),x=x.find(n),e(x,q,w[1],f,!1)});var r="triggerUpdate."+k;p.off("change.s3options",l).on("change.s3options",l,function(){var w=h($(this));p.trigger(r,w)});p.on(r,function(w,x,B){w=("row"==f.scope?x.closest(".edit-row.inline-form,.add-row.inline-form"):p).find(n);e(w,q,B,f,!0)})}}}}})(jQuery);
...
function(){},f=a.editable.types[c.type].buttons||a.editable.types.defaults.buttons,k=a.editable.types[c.type].content||a.editable.types.defaults.content,q=a.editable.types[c.type].element||a.editable.types.defaults.element,l=a.editable.types[c.type].reset||a.editable.types.defaults.reset,n=a.editable.types[c.type].destroy||a.editable.types.defaults.destroy,m=c.callback||function(){},p=c.intercept||function(t){return t},r=c.onedit||function(){},w=c.onsubmit||function(){},x=c.onreset||function(){},
...
y.append("<label>"+c.label+"</label>");c.formid&&y.attr("id",c.formid);var v=q.apply(y,[c,t]);c.inputcssclass&&("inherit"===c.inputcssclass?v.attr("class",a(t).attr("class")):v.attr("class",c.inputcssclass));var C=!1;if(c.loadurl){var A=t.setTimeout(function(){v.disabled=!0},100);a(t).html(c.loadtext);u={};u[c.id]=t.id;"function"===typeof c.loaddata?a.extend(u,c.loaddata.apply(t,[t.revert,c])):a.extend(u,c.loaddata);a.ajax({type:c.loadtype,url:c.loadurl,data:u,async:!1,cache:!1,success:function(D){t.clearTimeout(A);
z=D;v.disabled=!1}})}else if(c.data){var z=c.data;"function"===typeof c.data&&(z=c.data.apply(t,[t.revert,c]))}else z=t.revert;k.apply(y,[z,c,t]);v.attr("name",c.name);"none"!==c.width&&(u=c.width-(v.outerWidth(!0)-c.width),v.width(u));f.apply(y,[c,t]);c.showfn&&"function"===typeof c.showfn&&y.hide();a(t).html("");a(t).append(y);c.showfn&&"function"===typeof c.showfn&&c.showfn(y);e.apply(y,[c,t]);y.find(":input:visible:enabled:first").trigger("focus");c.select&&v.trigger("select");a(this).on("keydown",
function(D){27===D.which?(D.preventDefault(),l.apply(y,[c,t])):13==D.which&&D.shiftKey&&(D.preventDefault(),y.trigger("submit"))});if("cancel"===c.onblur)v.on("blur",function(D){A=t.setTimeout(function(){l.apply(y,[c,t])},500)});else if("submit"===c.onblur)v.on("blur",function(D){A=t.setTimeout(function(){y.trigger("submit")},200)});else if("function"===typeof c.onblur)v.on("blur",function(D){!1===c.onblur.apply(t,[v.val(),c,y])&&l.apply(y,[c,t])});y.on("submit",function(D){D.preventDefault();D.stopPropagation();
if(C)return!1;C=!0;A&&t.clearTimeout(A);if(C=!1!==w.apply(y,[c,t]))if(C=!1!==h.apply(y,[c,t]))if("function"===typeof c.target){D=function(I,H){C=!1;!1!==H&&(a(t).html(I),t.editing=!1,m.apply(t,[t.innerText,c]),a(t).html().trim()||a(t).html(c.placeholder))};var F=c.target.apply(t,[v.val(),c,D]);!1!==F&&void 0!==F&&D(F,F)}else{var E={};E[c.name]=v.val();E[c.id]=t.id;"function"===typeof c.submitdata?a.extend(E,c.submitdata.apply(t,[t.revert,c,E])):a.extend(E,c.submitdata);"PUT"===c.method&&(E._method=
...
c.tooltip&&a(t).attr("title",c.tooltip))},t.destroy=function(u){a(t).off(a(t).data("event.editable")).removeData("disabled.editable").removeData("event.editable");t.clearTimeouts();t.editing&&l.apply(u,[c,t])},t.clearTimeout=function(u){var y=a(t).data("timeouts");clearTimeout(u);if(y){var v=y.indexOf(u);-1<v?(y.splice(v,1),0>=y.length&&a(t).removeData("timeouts")):console.warn("jeditable clearTimeout could not find timeout "+u)}},t.clearTimeouts=function(){var u=a(t).data("timeouts");if(u){for(var y=
0,v=u.length;y<v;++y)clearTimeout(u[y]);u.length=0;a(t).removeData("timeouts")}},t.setTimeout=function(u,y){var v=a(t).data("timeouts"),C=setTimeout(function(){u();t.clearTimeout(C)},y);v||(v=[],a(t).data("timeouts",v));v.push(C);return C})})}};var b=function(d){var g=document.createElement("input");g.setAttribute("type",d);return"text"!==g.type?d:"text"};a.editable={types:{defaults:{element:function(d,g){d=a('<input type="hidden"></input>');a(this).append(d);return d},content:function(d,g,c){a(this).find(":input:first").val(d)},
...
"cluetip"));a(document).unbind(".cluetip");return this.unbind(".cluetip")}h=a.extend(!0,{},a.cluetip.defaults,h||{});g++;n=a.cluetip.backCompat||!h.multiple?"cluetip":"cluetip-"+g;var m="#"+n,p=a.cluetip.backCompat?"#":".",r=a.cluetip.setup.insertionType,w=a.cluetip.setup.insertionElement||"body";r=/appendTo|prependTo|insertBefore|insertAfter/.test(r)?r:"appendTo";var x=a(m);if(!x.length){x=a(a.cluetip.template)[r](w).attr("id",n).css({position:"absolute",display:"none"});var B=+h.cluezIndex;var t=
x.find(p+"cluetip-outer").css({position:"relative",zIndex:B});var u=x.find(p+"cluetip-inner");var y=x.find(p+"cluetip-title")}b=a("#cluetip-waitimage");b.length||(b=a("<div></div>").attr("id","cluetip-waitimage").css({position:"absolute"}));b.insertBefore(x).hide();var v=(parseInt(x.css("paddingLeft"),10)||0)+(parseInt(x.css("paddingRight"),10)||0);this.each(function(C){function A(){return!1}function z(K,T){var V=K.status;T.beforeSend(K.xhr,T);if("error"==V)T[V](K.xhr,K.textStatus);else if("success"==
...
var q;if(a("#add-row-"+g).hasClass("required")){var l=!0;for(q in k)"_id"!=q&&""!==k[q]&&(l=!1);if(l&&a("#add-"+g+"-none").length&&a("#read-row-"+g+"-0").length)return h.hide(),c.removeClass("hide").show(),a.Deferred().resolve()}var n=this._validate(f,"none",k),m=this;return n.then(function(p){if(null!==p){p._changed=!0;var r=f.data.push(p)-1;p._index=r;m._serialize();if(e){for(var w=[],x=f.fields,B,t,u,y=0,v=x.length;y<v;y++)B=x[y].name,t=a("#upload_"+g+"_"+B+"_none"),t.length&&(u="upload_"+g+"_"+
B+"_"+r,a("#"+u).remove(),t.attr({id:u,name:u})),w.push(p[B].text);m._resetAddRow();p=m._renderReadRow(g,r,w);m._appendReadRow(g,p);m._showHeaders()}}e&&(h.hide(),c.removeClass("hide").show())},function(){e&&(h.hide(),c.removeClass("hide").show());return n})},_updateRow:function(g){var c=this.formname,e=a("#rdy-"+c+"-0"),h;if(h=e.length?!0:!1){e.hide();var f=a("#throbber-"+c+"-0").removeClass("hide").show();this._removeErrors()}var k=this._deserialize(),q=this._collectData(k,"0",g);if(null===q)return h&&
(f.hide(),e.removeClass("hide").show()),a.Deferred().reject();if(q._delete)return k.data[g]._delete=!0,this._serialize(),a.Deferred().resolve();var l=this._validate(k,"0",q),n=this;return l.then(function(m){if(null!==m&&(m._id=k.data[g]._id,m._changed=!0,m._index=g,k.data[g]=m,n._serialize(),h)){var p=[],r=k.fields,w,x=function(){n._markChanged(n);n._catchSubmit()};for(w=0;w<r.length;w++){var B=r[w].name;p.push(m[B].text);var t=a("#sub_"+c+"_"+c+"_i_"+B+"_edit_default");var u=a("#sub_"+c+"_"+c+"_i_"+
...
(function(){var a=function(t,u,y){if("GET"==t.type){t.type="POST";var v=function(L){var O=L[0];return"$filter"==L||"$$"==L.slice(0,2)||"_"!=O&&(-1!=L.search(/\./)||"("==O&&-1!=L.search(/\)/))},C=t.url.split("#"),A=C[0],z=null,D=null;1<C.length&&(z=C[1]);C=A.split("?");A=C[0];1<C.length&&(D=C[1]);var F=t.data,E={};C={};var G,I,H,J,M=function(L,O,P){if(Array.isArray(P))for(H=0,G=P.length;H<G;H++)M(L,O,P[H]);else L.hasOwnProperty(O)?Array.isArray(L[O])?L[O].push(P):L[O]=[L[O],P]:L[O]=P};if(F){var R=
0;for(I=F.length;R<I;R++){var S=F[R];M(C,S.name,S.value)}}if(D)for(J in F=S3.queryString.parse(D),F)D=F[J],v(J)?M(E,J,D):M(C,J,D);t.data="ajax"==u?JSON.stringify(E):E;t.processData=!1;delete C.$search;u=A+"?$search="+u;y&&(delete C.$action,u=u+"&$action="+y);(y=S3.queryString.stringify(C))&&(u+="&"+y);null!==z&&(u+="#"+z);t.url=u}};S3.search.searchRewriteAjaxOptions=a;var b={timeout:1E4,retryLimit:5,dataType:"json",contentType:"application/json; charset=utf-8",processData:!1,async:!0,type:"POST"};
$.searchS3=function(t){t=$.extend({},b,t);a(t,"ajax");return $.ajaxS3(t)};$.searchDownloadS3=function(t,u){var y=$.extend({},b,{url:t});t=document.createElement("form");y.type="GET";a(y,"form");t.action=y.url;t.method="POST";t.target=u||"_self";t.enctype="multipart/form-data";if(u=y.data)for(var v in u)y=document.createElement("textarea"),y.name=v,y.value=JSON.stringify(u[v]),t.appendChild(y);t.style.display="none";document.body.appendChild(t);t.submit()};var d={},g=function(t){return t?(t=t.replace(/"/,
'\\"'),-1!=t.search(/,/)&&(t='"'+t+'"'),t):t},c=function(t){if(!t)return t;for(var u=[],y=!1,v=0,C=0;C<t.length;C++){var A=t[C];u[v]=u[v]||"";'"'==A?y=!y:","!=A||y?u[v]+=A:("NONE"==u[v]&&(u[v]=null),++v)}return u},e=function(t,u,y){void 0===t&&(t=$(".filter-form").first());t.data("noAutoSubmit",1);t.find(".text-filter").val("");t.find(".options-filter, .location-filter").each(function(){var v=$(this);if("select"==this.tagName.toLowerCase())v.val(""),v.hasClass("groupedopts-filter-widget")&&v.groupedopts("instance")?
v.groupedopts("refresh"):v.hasClass("multiselect-filter-widget")&&v.multiselect("instance")&&v.multiselect("refresh");else{var C=v.attr("id");$("input[name='"+C+"']:checked").each(function(){$(this).trigger("click")})}v.hasClass("location-filter")&&w(this)});t.find(".map-filter").each(function(){var v=$(this);v.val("");v=v.attr("id");v=S3.gis.maps[v+"-map"].s3.polygonButton;"drawpolygonclear-off"==v.getIconClass()&&v.items[0].btnEl.dom.click()});t.find(".range-filter-input").val("").trigger("change.slider");
t.find(".date-filter-input").each(function(){$(this).calendarWidget("clear")});t.find(".hierarchy-filter").each(function(){var v=$(this);v.hasClass("s3-cascade-select")?v.cascadeSelect("reset"):v.hierarchicalopts("reset")});t.find(".age-filter-input").val("");y||$(".filter-manager-widget",t).each(function(){var v=$(this);void 0!==v.filtermanager&&v.filtermanager("clear")});t.data("noAutoSubmit",0);u||t.trigger("optionChanged")};S3.search.clearFilters=e;var h=/__(?!link\.)([a-z_]+)$/,f=function(t){"undefined"==
typeof t&&(t=$(".filter-form").first());var u,y,v=[],C,A,z,D,F,E;$(".text-filter",t).each(function(){C=$(this);y=C.attr("id");A=$("#"+y+"-data").val();if(z=C.val().trim()){D=z.split(" ");var G=C.data("match"),I=[];for(u=0;u<D.length;u++)if(F=$.trim(D[u]),""!==F){var H=g("*"+F+"*");"any"==G?I.push(H):v.push([A,H])}"any"==G&&v.push([A,I.join(",")])}else v.push([A,null])});$(".s3-groupedopts-widget",t).prev(".options-filter.groupedopts-filter-widget").add($(".ui-multiselect",t).prev(".options-filter.multiselect-filter-widget")).add($(".options-filter,.options-filter.multiselect-filter-widget",
...
g($(this).val())});""===z||"*"==z?v.push([A,null]):v.push([A,z])});$(".map-filter",t).each(function(){C=$(this);y=C.attr("id");A=$("#"+y+"-data").val();(z=C.val())?v.push([A,z]):v.push([A,null])});$(".range-filter-input",t).each(function(){C=$(this);y=C.attr("id");A=$("#"+y+"-data").val();(z=C.val())?v.push([A,z]):v.push([A,null])});$(".date-filter-input",t).each(function(){C=$(this);if(C.calendarWidget("instance")){y=C.attr("id");A=$("#"+y+"-data").val();z=C.val();E=y.split("-").pop();if(C.hasClass("datetimepicker"))var G=
...
M.val();if(R){J=!0;M=M.calendarWidget("getJSDate",!1);var S=G(M);var L=$("#"+H+"-ge-data").val();L=L.replace(h,"")}if(z){J=!0;M=C.calendarWidget("getJSDate",!0);var O=G(M);var P=A.replace(h,"")}J&&(G="("+$("#"+H+"-negative").val()+" eq NONE)",R&&(G+=" or ("+L+' lt "'+S+'")'),z&&(G+=" or ("+P+' gt "'+O+'")'),O=$("#"+H+"-filterby"),O.length&&(O=O.val(),H=$("#"+H+"-filter_opts").val(),G+=" or ("+O+' belongs "'+H+'")'),v.push(["$filter",G]))}}else z?(M=C.calendarWidget("getJSDate",H),O=G(M),H&&C.hasClass("end_date")||
C.hasClass("optional")?(H=A.replace(h,""),v.push(["$filter","("+H+" "+E+' "'+O+'") or ('+H+" eq NONE)"])):v.push([A,O])):v.push([A,null])}});$(".s3-groupedopts-widget",t).prev(".location-filter.groupedopts-filter-widget").add($(".ui-multiselect",t).prev(".location-filter.multiselect-filter-widget")).add($(".location-filter,.location-filter.multiselect-filter-widget",t)).each(function(){C=$(this);y=C.attr("id");A=$("#"+y+"-data").val();z="";if("select"==this.tagName.toLowerCase()){if(D=$(this).val(),
D)for(u=0;u<D.length;u++){var G=g(D[u]);z=""===z?G:z+","+G}}else $("input[name='"+y+"']:checked").each(function(){z=""===z?g($(this).val()):z+","+g($(this).val())});""===z?v.push([A,null]):v.push([A,z])});$(".hierarchy-filter",t).each(function(){C=$(this);y=C.attr("id");A=$("#"+y+"-data").val();z="";if(D=C.hasClass("s3-cascade-select")?C.cascadeSelect("get"):C.hierarchicalopts("get"))for(u=0;u<D.length;u++)z=""===z?z+D[u]:z+","+D[u];""===z?v.push([A,null]):v.push([A,z])});$(".age-filter-input",t).each(function(){C=
$(this);y=C.attr("id");A=$("#"+y+"-data").val();z=C.val();""!==z?v.push([A,z]):v.push([A,null])});$(".value-filter",t).each(function(){C=$(this);y=C.attr("id");A=$("#"+y+"-data").val();C.prop("checked")?v.push([A,"None"]):v.push([A,null])});v.filter(function(G){return null!=G[1]}).length?t.addClass("has-active-filters"):t.removeClass("has-active-filters");return v};S3.search.getCurrentFilters=f;S3.search.setCurrentFilters=function(t,u){void 0===t&&(t=$(".filter-form").first());t.data("noAutoSubmit",
1);var y,v={},C,A,z;var D=0;for(C=u.length;D<C;D++){var F=u[D];var E=F[0];var G="string"==typeof F[1]?c(F[1]):F[1];v.hasOwnProperty(E)?v[E]=v[E].concat(G):v[E]=G}t.find(".text-filter").each(function(){A=$(this);y=A.attr("id");E=$("#"+y+"-data").val();if(v.hasOwnProperty(E)){A.is(":visible")||A.hasClass("active")||B(t);G=v[E];z="";if(G){var I;D=0;for(C=G.length;D<C;D++)if(I=G[D])0<D&&(z+=" "),"*"==I[0]&&(I=I.slice(1)),"*"==I.slice(-1)&&(I=I.slice(0,-1)),z+=I}A.val(z)}});t.find(".options-filter").each(function(){A=
$(this);y=A.attr("id");E=$("#"+y+"-data").val();var I=$('input:radio[name="'+y+'_filter"]:checked').val();if(this.tagName&&"select"==this.tagName.toLowerCase()){var H=!1,J=E.replace(h,"");if(v.hasOwnProperty(J+"__eq"))G=v[J+"__eq"],H=!0;else if(v.hasOwnProperty(J))G=v[J],H=!0;else if(v.hasOwnProperty(E))G=v[E],H=!0;else if("any"==I||"all"==I)v.hasOwnProperty(J+"__anyof")?(G=v[J+"__anyof"],H=!0,$('input:radio[name="'+y+'_filter"][value="any"]').prop("checked",!0)):v.hasOwnProperty(J+"__contains")&&
(G=v[J+"__contains"],H=!0,$('input:radio[name="'+y+'_filter"][value="all"]').prop("checked",!0));H&&(A.is(":visible")||A.hasClass("active")||B(t),A.val(G),A.hasClass("groupedopts-filter-widget")&&A.groupedopts("instance")?A.groupedopts("refresh"):A.hasClass("multiselect-filter-widget")&&A.multiselect("instance")&&A.multiselect("refresh"))}});t.find(".map-filter").each(function(){A=$(this);y=A.attr("id");E=$("#"+y+"-data").val();if(v.hasOwnProperty(E))if(A.is(":visible")||A.hasClass("active")||B(t),
G=v[E],G){A.val(G[0]);var I=y+"-map";S3.gis.maps[I].s3.polygonButtonLoaded()}else A.val(""),I=y+"-map",S3.gis.maps[I].s3.layerRefreshed()});t.find(".range-filter-input").each(function(){A=$(this);y=A.attr("id");E=$("#"+y+"-data").val();v.hasOwnProperty(E)&&(A.is(":visible")||A.hasClass("active")||B(t),(G=v[E])?A.val(G[0]):A.val(""))});t.find(".date-filter-input").each(function(){var I=$(this),H=$("#"+I.attr("id")+"-data").val(),J=H.replace(h,""),M=!1;v.hasOwnProperty(H)?M=v[H]:v.hasOwnProperty(J)&&
(M=v[J]);!1!==M&&(I.is(":visible")||I.hasClass("active")||B(t),M?(H=M[0].replace(" ","T"),I.calendarWidget("setJSDate",new Date(H))):I.calendarWidget("clear"))});t.find(".age-filter-input").each(function(){A=$(this);y=A.attr("id");E=$("#"+y+"-data").val();v.hasOwnProperty(E)&&(A.is(":visible")||A.hasClass("active")||B(t),(G=v[E])?A.val(G[0]):A.val(""))});t.find(".location-filter").each(function(){A=$(this);y=A.attr("id");E=$("#"+y+"-data").val();var I=$('input:radio[name="'+y+'_filter"]:checked').val();
if(this.tagName&&"select"==this.tagName.toLowerCase()){var H=!1;if(v.hasOwnProperty(E))G=v[E],H=!0;else if("any"==I||"all"==I)I=E.replace(h,""),v.hasOwnProperty(I+"__anyof")?(G=v[I+"__anyof"],H=!0,$('input:radio[name="'+y+'_filter"][value="any"]').prop("checked",!0)):v.hasOwnProperty(I+"__contains")&&(G=v[I+"__contains"],H=!0,$('input:radio[name="'+y+'_filter"][value="all"]').prop("checked",!0));H&&(A.is(":visible")||A.hasClass("active")||B(t),A.val(G),A.hasClass("groupedopts-filter-widget")&&A.groupedopts("instance")?
A.groupedopts("refresh"):A.hasClass("multiselect-filter-widget")&&A.multiselect("instance")&&A.multiselect("refresh"),w(this))}});t.find(".hierarchy-filter:visible").each(function(){A=$(this);y=A.attr("id");E=$("#"+y+"-data").val();v.hasOwnProperty(E)&&(A.is(":visible")||A.hasClass("active")||B(t),G=v[E],A.hasClass("s3-cascade-select")?A.cascadeSelect("set",G):A.hierarchicalopts("set",G))});t.data("noAutoSubmit",0);t.trigger("optionChanged")};var k=function(t,u){void 0===u&&(u=f());t=t.split("?");
var y={},v={},C,A=[];u=u.filter(function(I){return"$filter"==I[0]?(A.push(I),!1):!0});A.length&&u.push(A.reduce(function(I,H){return["$filter","("+I[1]+") and ("+H[1]+")"]}));var z=0;for(C=u.length;z<C;z++){var D=u[z];var F=D[0];D=D[1];null===D?y.hasOwnProperty(F)||(v[F]=!0):(v.hasOwnProperty(F)&&(v[F]=!1),y[F]=!0)}var E=[];if(1!=S3.search.stripFilters&&1<t.length){var G=t[1].split("&");z=0;for(C=G.length;z<C;z++)D=G[z].split("="),1<D.length&&(F=S3.urlDecode(D[0]),v[F]||y[F]||E.push(G[z]))}z=0;for(C=
u.length;z<C;z++)D=u[z],F=D[0],D=D[1],y[F]&&E.push(F+"="+encodeURIComponent(D));u=E.join("&");t=t[0];u&&(t=t+"?"+u);return t};S3.search.filterURL=k;S3.search.ajaxUpdateOptions=function(t,u){var y=$(t);t=y.find("input.filter-ajax-url");t.length&&(t=$(t[0]).val());$.ajax({url:t,dataType:"json"}).done(function(v){y.data("noAutoSubmit",1);for(var C in v){var A=$("#"+C);if(A.length){var z=v[C];if(A.hasClass("options-filter")){if("select"==A[0].tagName.toLowerCase()){var D=A.siblings(".no-options-available");
...
A.hasClass("multiselect-filter-widget")&&A.multiselect("instance")?(A.multiselect("refresh"),A.multiselect("instance").$button.show()):A.removeClass("hide").show()}}}else A.hasClass("date-filter")&&(A=z.min,z=z.max,$("#"+C+"-ge").calendarWidget("instance").option("minDateTime",A).option("maxDateTime",z).refresh(),$("#"+C+"-le").calendarWidget("instance").option("minDateTime",A).option("maxDateTime",z).refresh())}}y.data("noAutoSubmit",0);u&&u.apply()}).fail(function(v,C,A){console.log("UNAUTHORIZED"==
A?i18n.gis_requires_login:v.responseText)})};var q=function(t,u){$("#"+t[0].id).closest(".dt-wrapper").find(".dt-export").each(function(){var y=$(this),v=y.data("url");v&&y.data("url",k(v,u))})},l=function(t){var u=$("#"+t).find('input.filter-submit-url[type="hidden"]').first().val(),y=d[t],v;d[t]={};for(v in y){var C=$("#"+v);var A=C.is(":visible")?!0:!1;var z=y[v];C=z.needs_reload;if(A){if(C){var D=f($("#"+t));u=k(u,D);window.location.href=u}}else d[t][v]=z}for(v in y)C=$("#"+v),C.is(":visible")&&
(z=y[v],C=$("#"+v),C.hasClass("dataTable")?(t=C.dataTable(),z=z.ajaxurl,t.fnReloadAjax(z),q(t,D),$("#"+t[0].id+"_dataTable_filterURL").val(z)):C.hasClass("dl")?C.datalist("ajaxReload",z.queries):C.hasClass("map_wrapper")?S3.gis.refreshLayer("search_results",z.queries):C.hasClass("gi-container")?C.groupedItems("reload",null,z.queries):C.hasClass("pt-container")?C.pivottable("reload",null,z.queries):C.hasClass("tp-container")?C.timeplot("reload",null,z.queries):C.hasClass("s3-organizer")&&C.organizer("reload"))};
S3.search.filterFormAutoSubmit=function(t,u){t=$("#"+t);if(t.length&&u)t.on("optionChanged",function(){var y=$(this);if(!y.data("noAutoSubmit")){var v=y.data("autoSubmitTimeout");v&&clearTimeout(v);v=setTimeout(function(){x(y)},u);y.data("autoSubmitTimeout",v)}})};var n=function(){var t=new jQuery.Deferred;setTimeout(function y(){void 0!=S3.gis.maps?t.resolve("loaded"):"pending"===t.state()&&(t.notify("waiting for JS to load..."),setTimeout(y,500))},1);return t.promise()},m=function(t,u,y){void 0===
y&&(y=f($("#"+t)));d.hasOwnProperty(t)||(d[t]={});if(!d[t].hasOwnProperty(u)){var v=$("#"+u);if(v.hasClass("dl")||v.hasClass("gi-container")||v.hasClass("pt-container")||v.hasClass("tp-container")||v.hasClass("map_wrapper")||v.hasClass("s3-organizer"))var C=null;else if(v.hasClass("dataTable")){if(v=$("input#"+u+"_configurations"),v.length)if(C=JSON.parse($(v).val()).ajaxUrl,"undefined"!=typeof C)C=k(C,y);else return}else return;d[t][u]={needs_reload:!1,ajaxurl:C,queries:y}}};S3.search.setup_hidden_widget=
m;var p=function(t){t=$(t);t.hasClass("responsive")&&(t=t.DataTable())&&t.responsive&&t.responsive.recalc()},r=function(t,u){var y=u.find(".map_wrapper"),v=y.length;v?$.when(n()).then(function(){for(var C=S3.gis,A=0;A<v;A++){var z=y[A].attributes.id.value;void 0===C.maps[z]&&C.show_map(z,C.options[z])}l(t)},function(C){s3_debug(C)},function(C){s3_debug(C)}):l(t);u.find("table.dataTable.display").each(function(){p(this)})};S3.search.unhide_section=r;S3.search.summary_tabs=function(t,u,y){if(y)for(var v=
f($("#"+t)),C=y.split(","),A=0,z=C.length;A<z;A++)y=C[A],m(t,y,v);void 0!=u?($("#summary-tabs").tabs({active:u,activate:function(D,F){D=$(F.newPanel);D.removeClass("hide");if(F.newTab.length){var E=$(F.newTab).index();F=$("#"+t).find('input.filter-submit-url[type="hidden"]');if(F.length){F=F.first();var G=$(F).val(),I=G.split("?"),H=[];if(1<I.length){G=I[1].split("&");for(var J,M,R=0;R<G.length;R++)J=G[R].split("="),1<J.length&&(M=S3.urlDecode(J[0]),"t"!=M&&H.push(J[0]+"="+J[1]));H.push("t="+E);E=
H.join("&");I=I[0];E&&(I=I+"?"+E)}else I=G+"?t="+E;$(F).val(I)}}r(t,D)}}).css({visibility:"visible"}),$('.ui-tabs-panel[aria-hidden="false"]').first().removeClass("hide").find("table.dataTable.display").each(function(){p(this)})):$("#summary-tabs").css({visibility:"visible"}).find("table.dataTable.display").each(function(){p(this)})};S3.search.summary_maps=function(t){for(var u=$("#summary-common, #summary-sections").find(".map_wrapper"),y=0;y<u.length;y++){var v=u[y];if(!v.hidden){var C=S3.gis;v=
v.attributes.id.value;if(void 0===C.maps[v]){var A=C.options[v];void 0!=A&&(C.show_map(v,A),v=f($("#"+t)),C.refreshLayer("search_results",v))}}}};S3.search.s3map=function(t){var u=S3.gis;void 0===t&&(t="default_map");u.show_map(t,u.options[t]);t=f();u.refreshLayer("search_results",t)};var w=function(t){var u=t.name,y=u.slice(0,-1),v=parseInt(u.slice(-1)),C=$("#"+u);if(C.val()){var A=v+1,z=y+A,D=$("#"+z);D.length||(A=v+2,z=y+A,D=$("#"+z));if(D.length){var F=z.replace(/-/g,"_");S3[F]();D.next(".ui-multiselect").show();
F=S3.location_filter_hierarchy;if(void 0!=S3.location_name_l10n){D=!0;var E=S3.location_name_l10n}else D=!1;t.options1=[];t.options2=[];t.options3=[];t.options4=[];t.options5=[];for(u=v;0<=u&&!F.hasOwnProperty("L"+u);u--);var G=function(L){var O,P;for(O in L)if(L.hasOwnProperty(O)){O&&"null"!=O&&t["options"+A].push(O);var Q=L[O];if("object"===typeof Q&&(z=A+1,$("#"+y+z).length||(z=A+2),$("#"+y+z).length))for(P in Q)Q.hasOwnProperty(P)&&P&&"null"!=P&&t["options"+z].push(P)}},I=function(L,O){var P,
Q,U=$("#"+y+O).val();for(Q in L)if(L.hasOwnProperty(Q))if(null===U)if(O===v)G(L[Q]);else{var N=O+1;$("#"+y+N).length||N++;I(L[Q],N)}else for(P in U)U[P]===Q&&(O===v?G(L[Q]):(N=O+1,$("#"+y+N).length||N++,I(L[Q],N)))};I(F["L"+u],u);for(F=A;5>=F;F++){var H=$("#"+y+F);if(H.length){var J=t["options"+F];J.sort();var M="";for(var R in J)if(J.hasOwnProperty(R)){u=J[R];var S=D?E[u]||u:u;M+='<option value="'+u+'">'+S+"</option>"}H.html(M);if(H.hasClass("groupedopts-filter-widget")&&H.groupedopts("instance"))try{H.groupedopts("refresh")}catch(L){}else H.hasClass("multiselect-filter-widget")&&
H.multiselect("instance")&&H.multiselect("refresh");F===A&&(H.next("button").removeClass("hidden").show(),u=C.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect"),u.length&&(u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&u.hide())))))}}}}else{for(F=
v+1;5>=F;F++)if(H=$("#"+y+F),H.length)if(H.html(""),H.hasClass("groupedopts-filter-widget")&&H.groupedopts("instance"))try{H.groupedopts("refresh")}catch(L){}else H.hasClass("multiselect-filter-widget")&&H.multiselect("instance")&&H.multiselect("refresh");u=C.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect");u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=
u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&u.hide()))))}},x=function(t){S3.hideAlerts("warning");var u=t.attr("id"),y=t.find('input.filter-submit-url[type="hidden"]').val(),v=f(t);if(t.hasClass("filter-ajax")){t=t.find('input.filter-submit-target[type="hidden"]').val();d[u]={};t=t.split(" ");var C={},A;for(A=0;A<t.length;A++){var z=t[A];var D=$("#"+z);var F=D.is(":visible")?!0:!1;var E=!1;var G=null;D.hasClass("dataTable")?
(E=$("input#"+t[A]+"_configurations"),E.length&&(G=JSON.parse($(E).val()),G=G.ajaxUrl,G="undefined"!=typeof G?k(G,v):null),G?(C[t[A]]=G,E=!1):E=!0):D.hasClass("dl")||D.hasClass("map_wrapper")||D.hasClass("cms_content")||D.hasClass("gi-container")||D.hasClass("pt-container")||D.hasClass("tp-container")||D.hasClass("s3-target")||D.hasClass("s3-organizer")?E=!1:F?(y=k(y,v),window.location.href=y):E=!0;F||(d[u][z]={needs_reload:E,ajaxurl:G,queries:v})}for(A=0;A<t.length;A++)z=t[A],D=$("#"+z),D.is(":visible")&&
(D.hasClass("dataTable")?(u=D.dataTable(),z=C[z],u.fnReloadAjax(z),q(u,v),$("#"+u[0].id+"_dataTable_filterURL").val(z)):D.hasClass("dl")?D.datalist("ajaxReload",v):D.hasClass("map_wrapper")?S3.gis.refreshLayer("search_results",v):D.hasClass("gi-container")?D.groupedItems("reload",null,v):D.hasClass("pt-container")?D.pivottable("reload",null,v):D.hasClass("tp-container")?D.timeplot("reload",null,v):D.hasClass("s3-target")?D.s3Target("reload",k(y,v)):D.hasClass("s3-organizer")&&D.organizer("reload"))}else y=
k(y,v),window.location.href=y},B=function(t,u){t=$(t);var y;t.find(".advanced").each(function(){var v=$(this);v.hasClass("hide")?(v.removeClass("hide").show().find(".multiselect-filter-widget,.groupedopts-filter-widget").each(function(){var C=$(this);C.addClass("active");C.hasClass("groupedopts-filter-widget")&&C.groupedopts("instance")?C.groupedopts("refresh"):C.hasClass("multiselect-filter-widget")&&C.multiselect("instance")&&C.multiselect("refresh")}),y=!0):(v.addClass("hide").hide().find(".multiselect-filter-widget,.groupedopts-filter-widget").removeClass("active"),
y=!1)});t=$(t.find(".filter-advanced-label"));y?t.text(t.data("off")).siblings().toggle():t.text(t.data("on")).siblings().toggle()};$(function(){$(".groupedopts-filter-widget:visible,.multiselect-filter-widget:visible").addClass("active");$(".filter-clear").on("click",function(){var t=$(this).closest(".filter-form");e(t)});$(".show-filter-manager").on("click",function(){$(".filter-manager-row").removeClass("hide").show();$(".show-filter-manager").hide()});$(".filter-submit").on("click",function(){x($(this).closest(".filter-form"))});
$(".filter-form").on("dataChanged",function(t,u,y){u&&(t=$(this).find("input.filter-submit-target").val())&&(t=t.split(" "),t.length&&-1!=$.inArray(u+"",t)&&S3.search.ajaxUpdateOptions(this,y));return!1});$(".filter-advanced").on("click",function(){B($(this).closest("form"))});$(".location-filter").on("change",function(){w(this)});$(".text-filter").on("keyup.autosubmit",function(t){27==t.keyCode&&$(this).val("").closest("form").trigger("optionChanged")});$(".text-filter, .range-filter-input").on("input.autosubmit",
...
$(this);$.when(n()).then(function(){var u=t.attr("id"),y=$("#"+u),v,C=S3.gis,A=C.maps[u+"-map"],z=A.s3;z.pointPlaced=function(D){var F={internalProjection:A.getProjectionObject(),externalProjection:C.proj4326};v=(new OpenLayers.Format.WKT(F)).write(D);y.val('"'+v+'"').trigger("change")};z.polygonButtonOff=function(){y.val("").trigger("change")};z.layerRefreshed=function(){var D=z.polygonButton;D&&"drawpolygonclear-off"==D.getIconClass()&&(z.lastDraftFeature?z.lastDraftFeature.destroy():1<z.draftLayer.features.length&&
z.draftLayer.features[0].destroy(),D.control.deactivate(),D.items[0].pressed=!0)};z.polygonButtonLoaded=function(){if(v=y.val()){z.polygonButton.items[0].btnEl.dom.click();var D=OpenLayers.Geometry.fromWKT(v);D.transform(C.proj4326,A.getProjectionObject());D=new OpenLayers.Feature.Vector(D,{},null);var F=z.draftLayer;F.addFeatures([D]);z.lastDraftFeature=D;A.zoomToExtent(F.getDataExtent())}};z.polygonButtonLoaded()},function(u){s3_debug(u)},function(u){s3_debug(u)})});$(".filter-form").each(function(){f($(this))});
$(".text-filter").on("keypress",function(t){return 13==t.which?(t.preventDefault(),!1):!0})})})();
...
(function(){S3.autocomplete={};S3.autocomplete.normal=function(d,g,c,e,h,f,k,q,l){var n="dummy_"+e,m=$("#"+n);if(m.length){g=S3.Ap.concat("/",g,"/",c,"/search_ac.json?field=",d);h&&(g+="&"+h);f&&(g+="&link="+f);var p=$("#"+e).hide();e=p.val();var r;e&&(r={value:e,label:m.val()});p.data("existing",r);p.data("url",g);var w=$("#"+n+"_throbber");void 0==q&&(q=800);void 0==l&&(l=2);m.val();m.autocomplete({delay:q,minLength:l,source:function(x,B){$.ajax({url:p.data("url"),data:{term:x.term}}).done(function(t){var u=
{id:0};0==t.length?(p.val("").trigger("change"),u[d]=i18n.no_matching_records):u[d]=i18n.none_of_the_above;t.push(u);B(t)})},search:function(x,B){w.removeClass("hide").show();return!0},response:function(x,B,t){w.hide();return t},focus:function(x,B){return!1},select:function(x,B){x=B.item;x.id?(m.val(x[d]),p.val(x.id).trigger("change"),r={value:x.id,label:x[d]}):(m.val(""),p.val("").trigger("change"));k&&eval(k);return!1}}).data("ui-autocomplete")._renderItem=function(x,B){var t=B.label?B.label:B[d];
...
n);l.data("url",q);var m=$("#"+f+"_throbber");g&&(q+="?level="+g);void 0==e&&(e=800);void 0==c&&(c=2);k.autocomplete({delay:e,minLength:c,source:function(p,r){$.ajax({url:l.data("url"),data:{term:p.term}}).done(function(w){0==w.length?(l.val("").trigger("change"),w.push({id:0,value:"",label:i18n.no_matching_records})):w.push({id:0,value:"",label:i18n.none_of_the_above});r(w)})},search:function(p,r){m.removeClass("hide").show();return!0},response:function(p,r,w){m.hide();return w},focus:function(p,
r){return!1},select:function(p,r){p=r.item;p.id?(k.val(r.item.name),l.val(p.id).trigger("change"),n={value:p.id,name:r.item.name}):(k.val(""),l.val("").trigger("change"));h&&eval(h);return!1}}).data("ui-autocomplete")._renderItem=function(p,r){if(void 0!=r.label)var w=r.label;else w=r.name?r.match_type?r.next_string?r.match_string+"<b>"+r.next_string+"</b>":r.match_string:r.name:"",r.addr&&(w=w?w+(", "+r.addr):r.addr),r.L5&&(w=w?w+(", "+r.L5):r.L5),r.L4&&(w=w?w+(", "+r.L4):r.L4),r.L3&&(w=w?w+(", "+
r.L3):r.L3),r.L2&&(w=w?w+(", "+r.L2):r.L2),r.L1&&(w=w?w+(", "+r.L1):r.L1),r.L0&&(w=w?w+(", "+r.L0):r.L0);return $("<li>").data("item.autocomplete",r).append("<a>"+w+"</a>").appendTo(p)};k.on("blur",function(){n&&n.name!=k.val()&&l.val("").trigger("change")})}};var a=function(d){return void 0!=d.label?d.label:d.org||d.job?b(d):d.name};S3.autocomplete.person=function(d,g,c,e,h,f,k){var q="dummy_"+c,l=$("#"+q);if(l.length){d=S3.Ap.concat("/",d,"/",g,"/search_ac.json");e&&(d+="?"+e);var n=$("#"+c).hide();
c=n.val();var m;c&&(m={value:c,name:l.val()});n.data("existing",m);n.data("url",d);var p=$("#"+q+"_throbber");void 0==f&&(f=800);void 0==k&&(k=2);l.autocomplete({delay:f,minLength:k,source:function(r,w){$.ajax({url:n.data("url"),data:{term:r.term}}).done(function(x){0==x.length?(n.val("").trigger("change"),x.push({id:0,value:"",label:i18n.no_matching_records})):x.push({id:0,value:"",label:i18n.none_of_the_above});w(x)})},search:function(r,w){p.removeClass("hide").show();return!0},response:function(r,
w,x){p.hide();return x},focus:function(r,w){return!1},select:function(r,w){r=w.item;r.id?(w=a(r),l.val(w),n.val(r.id).trigger("change"),m={value:r.id,name:w}):(l.val(""),n.val("").trigger("change"));h&&eval(h);return!1}}).data("ui-autocomplete")._renderItem=function(r,w){var x=a(w);return $("<li>").data("item.autocomplete",w).append("<a>"+x+"</a>").appendTo(r)};l.on("blur",function(){m&&m.name!=l.val()&&n.val("").trigger("change")})}};S3.autocomplete.pentity=function(d,g,c,e,h,f,k){var q="dummy_"+
c,l=$("#"+q);if(l.length){var n=S3.Ap.concat("/",d,"/",g,"/search_ac.json"),m=$("#"+c).hide();d=m.val();var p;d&&(p={value:d,name:l.val()});m.data("existing",p);m.data("url",n);var r=$("#"+q+"_throbber");void 0==h&&(h=800);void 0==f&&(f=2);l.autocomplete({delay:h,minLength:f,source:function(w,x){n=m.data("url");k&&(n+="?types="+k);$.ajax({url:n,data:{term:w.term}}).done(function(B){0==B.length?(m.val("").trigger("change"),B.push({id:0,value:"",label:i18n.no_matching_records})):B.push({id:0,value:"",
label:i18n.none_of_the_above});x(B)})},search:function(w,x){r.removeClass("hide").show();return!0},response:function(w,x,B){r.hide();return B},focus:function(w,x){return!1},select:function(w,x){w=x.item;w.id?(l.val(w.name),m.val(w.id).trigger("change"),p={value:w.id,name:w.name}):(l.val(""),m.val("").trigger("change"));e&&eval(e);return!1}}).data("ui-autocomplete")._renderItem=function(w,x){var B=x.label?x.label:x.name;return $("<li>").data("item.autocomplete",x).append("<a>"+B+"</a>").appendTo(w)};
...
p,r){n.hide();return r},focus:function(m,p){return!1},select:function(m,p){m=p.item;m.id?(f.val(m.name),q.val(m.id).trigger("change"),l={value:m.id,name:m.name}):(f.val(""),q.val("").trigger("change"));g&&eval(g);return!1}}).data("ui-autocomplete")._renderItem=function(m,p){if(void 0!=p.label)var r=p.label;else if(p.match_type)if(r="<b>"+p.match_string+"</b>",p.pre_string&&(r=p.pre_string+r),p.next_string&&(r+=p.next_string),"name"==p.match_type){var w=p.addr;var x=p.L4||p.L3||p.L2||p.L1;if(w||x)w?
(r+=" ("+w,x&&(r+=", "+x),r+=")"):r+=" ("+x+")";var B=p.org;x=p.instance_type;if(B||x)x?(r+=" ("+S3.org_site_types[x],B&&(r+=", "+B),r+=")"):r+=" ("+B+")"}else if("addr"==p.match_type){if(r=p.name+" ("+r,r=(x=p.L4||p.L3||p.L2||p.L1)?r+(", "+x+")"):r+")",B=p.org,x=p.instance_type,B||x)x?(r+=" ("+S3.org_site_types[x],B&&(r+=", "+B),r+=")"):r+=" ("+B+")"}else if("org"==p.match_type){B=p.name;w=p.addr;x=p.L4||p.L3||p.L2||p.L1;if(w||x)w?(B+=" ("+w,x&&(B+=", "+x),B+=")"):B+=" ("+x+")";r=(x=p.instance_type)?
B+" ("+S3.org_site_types[x]+", "+r+")":B+" ("+r+")"}else{if(B=p.name,r=(w=p.addr)?B+" ("+w+", "+r+")":B+" ("+r+")",B=p.org,x=p.instance_type,B||x)x?(r+=" ("+S3.org_site_types[x],B&&(r+=", "+B),r+=")"):r+=" ("+B+")"}else r=p.name;return $("<li>").data("item.autocomplete",p).append("<a>"+r+"</a>").appendTo(m)};f.on("blur",function(){l&&l.name!=f.val()&&q.val("").trigger("change")})}}})();
